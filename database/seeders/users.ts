...
export default class UserSeeder extends BaseSeeder {
  public async run() {
    ...
    await User.createMany([   // passwords will be hashed and saved in the hook functions
      { name: 'admin', hashedPassword: passwordAdmin, salt: saltAdmin, role: 'ADMIN' },
      { name: 'foo', hashedPassword: passwordFoo, salt: saltFoo }
    ])
  }
}
